        ...
        <Reveal>
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-5 space-y-4 text-sm leading-relaxed text-muted">
              <p>
                <strong className="text-ink-soft">Ферма CS2</strong> (она же ферма кс2, ферма стим
                или фарм CS2) — это набор аккаунтов Steam, которые каждую неделю получают дроп
                предметов и кейсов CS2. Предметы продаются на торговой площадке, а доход зависит от
                количества аккаунтов, выпавшего дропа и текущих цен на рынке. Чем больше аккаунтов,
                тем больше еженедельных попыток и выше шанс поймать дорогой предмет. По сути это
                ферма аккаунтов Steam под дроп CS2 — раньше такие фермы называли фермой CS:GO.
              </p>
              <p>
                Мы делаем{" "}
