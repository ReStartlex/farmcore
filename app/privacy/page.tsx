      ...
      <article className="container-x max-w-3xl py-14">
        ...
        <div className="mt-8 space-y-7 text-sm leading-relaxed text-ink-soft">
          <Block n="1" title="Общие положения">
            ...
            {" "}{site.brand} (далее — «Сайт»). Оператор обработки данных — владелец проекта{" "}
            {site.brand} (далее — «Оператор»); связь с Оператором по вопросам обработки данных —
            через Telegram{" "}
            <a
            ...
            . Оставляя заявку, вы подтверждаете согласие с условиями настоящей Политики в
